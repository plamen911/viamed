...
function loadFamilyWeights($checkup_id) {
	...
	<table cellpadding="0" cellspacing="0">
	  <tr class="underline">
	    ...
	    <td align="left"><textarea id="fweights_descr" name="fweights_descr" rows="2" cols="120"><?=HTMLFormat($fweights_descr)?></textarea></td>
	    <td align="left">&nbsp;</td>
	  </tr>	
	  ...
	  <tr class="underline">
	    ...
	    <td><textarea id="diagnosis_<?=$row['family_weight_id']?>" name="diagnosis_<?=$row['family_weight_id']?>" rows="2" cols="120"><?=HTMLFormat($row['diagnosis'])?></textarea></td>
	    <td>&nbsp;</td>
	  </tr>
	  <?php } ?>
	  <tr>
	  ...
	  <tr>
	    <td><strong>Диагноза</strong></td>
	    <td><textarea id="diagnosis_0" name="diagnosis_0" rows="2" cols="120" class="newItem"></textarea></td>
	    <td>&nbsp;</td>
	  </tr>
	</table>
	<?php
...
function loadAnamnesis($checkup_id = 0) {
	...
	<table cellpadding="0" cellspacing="0">
	  <tr class="underline">
	    <td align="left"><strong>Описание</strong></td>
	    <td align="left"><textarea id="anamnesis_descr" name="anamnesis_descr" rows="2" cols="120"><?=HTMLFormat($anamnesis_descr)?></textarea></td>
	    <td align="left">&nbsp;</td>
	  </tr>
	  <?php foreach ($rows as $row) { ?>
	  <tr>
	  ...
	  <tr class="underline">
	    ...
	    <td align="left"><textarea id="diagnosis_<?=$row['anamnesis_id']?>" name="diagnosis_<?=$row['anamnesis_id']?>" rows="2" cols="120"><?=HTMLFormat($row['diagnosis'])?></textarea></td>
	    <td align="left">&nbsp;</td>
	  </tr>
	  <?php } ?>
	  <tr>
	  ...
	  <tr>
	    <td align="left"><strong>Анамнеза</strong></td>
	    <td align="left"><textarea id="diagnosis_0" name="diagnosis_0" rows="2" cols="120" class="newItem"></textarea></td>
	    <td align="left">&nbsp;</td>
	  </tr>
	</table>
	<?php
