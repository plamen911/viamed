    ...
    function scwSetDefaultLanguage()
        {try
            ...
            {// English
             scwToday               = 'Днес:';
             scwClear               = 'Изчисти';
             scwDrag                = 'кликнете и влачете';
             scwArrMonthNames       = ['Яну','Фев','Мар','Апр','Май','Юни',
                                       'Юли','Авг','Сеп','Окт','Ное','Дек'];
             scwArrWeekInits        = ['Н','П','В','С','Ч','П','С'];
             scwInvalidDateMsg      = 'Въведената дата е невалидна.\n';
             scwOutOfRangeMsg       = 'Въведената дата е невалидна.';
             scwDoesNotExistMsg     = 'Въведената дата не съществува.';
