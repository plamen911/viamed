...
$sect->writeText('След анализ на условията на труд и факторите на работната среда в дружеството, може да се направи извода: регистрираната патология не се свързва с условията на труд по работните места и упражняваната професия - заболяванията нямат професионално обусловен характер.', $times12, $alignLeft);

$sect->addEmptyParagraph();

$sect->writeText('<b><u>Препоръки към административното ръководство:</u></b>', $times12, $alignLeft);
$sect->writeText('<b>1. Анализът да се предостави на групата по условия на труда във фирмата.</b>', $times12, $alignLeft);
$sect->writeText('<b>2. При постъпване на работа работодателят да изисква медицинско свидетелство от предварителните прегледи със заключение за професионална пригодност от лекар специалист.</b>', $times12, $alignLeft);
$sect->writeText('<b>3. Новопостъпилите работещи да преминават задължителни предварителни медицински прегледи в съответствие с Наредба № 3/28.02.1987 г.</b>', $times12, $alignLeft);
$sect->writeText('<b>4. При постъпване на нов работещ работодателят да уреди служебното прехвърляне на неговото здравно досие.</b>', $times12, $alignLeft);
$sect->writeText('<b>5. Спазване физиологичните режими на труда и почивка.</b>', $times12, $alignLeft);
$sect->writeText('<b>6. Констатираните случаи на заболявания се насочват към личния лекар за допълнителни изследвания и евентуална диспансеризация.</b>', $times12, $alignLeft);
